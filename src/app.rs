    ...
    html! {
        <>
            ...
            <svg
                ...
                xmlns="http://www.w3.org/2000/svg"
            >
                 { Html::from_html_unchecked(data.into()) }
            </svg>
        </>
    }
}
